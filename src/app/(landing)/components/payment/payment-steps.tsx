    ...
    <CardWithHeader title="Payment Steps">
      <div className="p-5">
        <ol className="list-decimal text-xs pl-2 flex flex-col gap-4 mb-5">
          <li>
            Transfer the total amount of <b>{formatCurrency(totalPrice)}</b> to your preferred bank account listed under Payment
      ...
      <div className="border-t border-gray-200 p-4">
        <div className="flex justify-between font-semibold">
          ...
          <div className="text-primary text-md">{priceFormatter(totalPrice)}</div>
        </div>
