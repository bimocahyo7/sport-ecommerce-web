...
const BankInfoList = ({ banks, onEdit, onDelete }: TBankProps) => {
  return (
    <div className="grid grid-cols-3 gap-8">
      {banks.map((bank) => (
        <div className="bg-white rounded-lg border border-gray-200" key={bank._id}>
          <div className="flex justify-between p-5">
            ...
            <div className="flex gap-2 -mt-5 text-gray-600">
              <button onClick={() => onEdit(bank)} className="hover:text-red-500 transition-colors cursor-pointer">
                <FiEdit2 size={20} />
              </button>
              <button
