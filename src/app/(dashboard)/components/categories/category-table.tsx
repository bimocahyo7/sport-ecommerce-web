...
const categoryData = [
  {
    ...
    description: "Equipment for running and jogging activities",
  },
  {
    name: "Football",
    imageUrl: "/images/categories/category-football.png",
    description: "Gear for football and soccer enthusiasts",
  },
  {
    name: "Tennis",
    imageUrl: "/images/categories/category-tennis.png",
    description: "Accessories and equipment for tennis players",
  },
];
